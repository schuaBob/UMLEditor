...
public class UMLModebar extends JPanel {
    ...
    UMLModebar() {
        ...
        ModeBtn associationBtn = new ModeBtn("Association", new ImageIcon("img/association.png"), menu.getMode("association"));
        this.add(associationBtn);

        ModeBtn generalizationBtn = new ModeBtn("Generalization", new ImageIcon("img/generalization.png"), menu.getMode("generalization"));
        this.add(generalizationBtn);

        ModeBtn compositionBtn = new ModeBtn("Composition", new ImageIcon("img/composition.png"), menu.getMode("composition"));
